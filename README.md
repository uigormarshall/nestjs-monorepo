...
Monorepo nestjs usado para estudos e testes.
...
```
## Rodando projeto
Para rodar um projeto basta usar o seguinte comando:
```bash
npm run start todo-api
```
Caso queira rodar outro projeto, basta substituir todo-api pelo nome do projeto desejado
...
## Pontos de melhoria/correção
 - [x] Adicionar bcrypt na comparação de senha
